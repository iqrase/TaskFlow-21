...
import { SIDEBAR_CLASSES, PRODUCTIVITY_CARD, LINK_CLASSES, menuItems, TIP_CARD } from '../assets/dummy.jsx'
        ...
        <>
            ...
            <div className={SIDEBAR_CLASSES.desktop}>
                <div className='h-full w-full bg-white flex flex-col'>
                    <div className='p-5 border-b border-purple-100 pt-16'>
