...
import { Trash2, Edit, CheckCircle, Circle, Calendar, Flag, Share2 } from 'lucide-react'
                ...
                <div className='flex-1 min-w-0'>
                    ...
                    <div className='flex items-start justify-between gap-1.5'>
                        ...
                        <div className='flex items-center gap-0.5 shrink-0 ml-1'>
                            {/*Share button */}
                            <button onClick={() => setShowShareModal(true)} disabled={loading}
                    ...
                    <div className='flex items-center gap-2 mt-2 flex-wrap'>
                        ...
                        {task.sharedWith?.length > 0 && (
                            <span className='inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full bg-blue-100 text-blue-600 shrink-0'>
