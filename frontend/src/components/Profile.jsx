...
const FULL_BUTTON = 'w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 rounded-lg transition'
const DANGER_BTN = 'w-full flex items-center justify-center gap-2 border border-red-400 text-red-500 hover:bg-red-50 font-semibold py-2 rounded-lg transition'
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='max-w-4xl mx-auto p-6'>
        <button onClick={() => navigate(-1)} className='flex items-center text-purple-600 hover:text-purple-800 mb-6 font-medium'>
