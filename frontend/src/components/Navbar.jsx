...
import { Zap, Settings, ChevronDown, LogOut, Menu } from 'lucide-react';
        ...
        <header className='sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans'>
            <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <button
                        onClick={onMenuClick}
                        className='lg:hidden p-2 rounded-lg text-gray-600 hover:text-purple-600 hover:bg-purple-50 transition-colors duration-200'>
